...
commonQuery.aggregateSum = function aggregateFunc(model, group, condition) {
    return new Promise(function(resolve, reject) {
...
commonQuery.aggregateProject = function aggregateFunc(model, project, condition) {
    return new Promise(function(resolve, reject) {
